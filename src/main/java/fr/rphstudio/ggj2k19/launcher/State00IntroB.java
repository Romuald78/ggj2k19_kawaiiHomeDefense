...
public class State00IntroB extends BasicGameState
{   
    //------------------------------------------------
    // PUBLIC CONSTANTS
    //------------------------------------------------
    public static final int ID = 22000;
    ...
    {
        // Init game state
        GameState gs = this.gameObject.getState(State00IntroC.ID);
        try
        {
            if(gs == null)
            {
                gs = new State00IntroC();
                this.gameObject.addState(gs);
            }
            gs.init(this.container, this.gameObject);
        }
        ...
        // enter menu
        this.gameObject.enterState( State00IntroC.ID, new FadeOutTransition(Color.black, Common.TIME_FADE_OUT2), new FadeInTransition(Color.black, Common.TIME_FADE_IN2) );
    } 
    ...
    public void init(GameContainer container, StateBasedGame sbGame) throws SlickException
    {
        ...
        this.background = ResourceLoader.getImage("LOGO_SLICK");
        
        // Load font component
        this.font = new RenderFont("powered by SLICK-2D, a java gaming library", ResourceLoader.getImage("FONT_ARIAL"), ArialSpriteFont.getCharInfo(), 100.0f, 0.35f, new Color(1.0f, 1.0f, 1.0f, 1.0f) );
    ...
    public void render(GameContainer contain, StateBasedGame game, Graphics g) throws SlickException
    {
        ...
        this.font.setPosition((refX)/Common.NB_PIXELS_PER_METER, (refY+this.background.getHeight())/Common.NB_PIXELS_PER_METER);
